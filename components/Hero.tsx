      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          <a
            ...
            className="group inline-flex items-center gap-2.5 rounded-xl bg-gradient-to-r from-orange-600 via-amber-600 to-rose-600 px-7 py-3.5 text-sm font-bold text-white shadow-xl shadow-orange-950/40 transition-all duration-200 hover:scale-[1.02] hover:shadow-orange-600/40"
          >
